...
(function (Marketplace) {
    var NotificationUI = (function () {
        ...
        NotificationUI.prototype.AddContact = function (item) {
            this.contacts.push(item);
        };

        NotificationUI.prototype.AddPromotion = function (item) {
            this.promotions.push(item);
        };

        NotificationUI.prototype.DisplayContactList = function () {
        ...
        NotificationUI.prototype.DisplayPromotionList = function () {
    ...
    Marketplace.NotificationUI = NotificationUI;
