...
(function (Marketplace) {
    var PurchaseUnitUI = (function () {
        function PurchaseUnitUI() {
            //elementid: string;
            this.items = [];
        }
        ...
        //}
        PurchaseUnitUI.prototype.AddItem = function (item) {
            this.items.push(item);
        };

        PurchaseUnitUI.prototype.GenerateListview = function (event) {
            var listString = "";
        ...
        PurchaseUnitUI.prototype.DisplayItemFormat = function (value) {
        ...
        PurchaseUnitUI.prototype.DisplayPropertyHeaders = function (id) {
            var index = this.GetPropertyDetailsIndex(id);
        ...
        PurchaseUnitUI.prototype.GetPropertyDetailsIndex = function (id) {
            var selectedIndex = -1;
            $.each(this.items, function (index, value) {
        ...
        PurchaseUnitUI.prototype.DisplayPropertyDetails = function (id) {
            var index = this.GetPropertyDetailsIndex(id);
        ...
        PurchaseUnitUI.prototype.DisplayPurchaseContracts = function (id) {
            var index = this.GetPropertyDetailsIndex(id);
        ...
        PurchaseUnitUI.prototype.DisplaySolicitor = function (id) {
            var selectedIndex = this.GetPropertyDetailsIndex(id);
        ...
        PurchaseUnitUI.prototype.DisplayFinancialInfo = function (id) {
            var selectedIndex = this.GetPropertyDetailsIndex(id);
        ...
        return PurchaseUnitUI;
    })();
    Marketplace.PurchaseUnitUI = PurchaseUnitUI;
...
//# sourceMappingURL=PurchaseUnitUI.js.map
